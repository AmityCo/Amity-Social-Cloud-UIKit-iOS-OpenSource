...
- (nullable UIImage *)imageByScalingToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
...
- (nullable UIImage *)imageByScalingToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode scale:(CGFloat)scale;
...
- (nullable UIImage *)imageByCroppingToBounds:(CGRect)bounds;
...
- (nullable UIImage *)imageByCroppingToBounds:(CGRect)bounds scale:(CGFloat)scale;
...
- (nullable UIImage *)imageByScalingAspectFillSize:(CGSize)size;
...
- (nullable UIImage *)imageByScalingAspectFillSize:(CGSize)size scale:(CGFloat)scale;
...
- (nullable UIImage *)imageByScalingToFillSize:(CGSize)size;
...
- (nullable UIImage *)imageByScalingToFillSize:(CGSize)size scale:(CGFloat)scale;
...
- (nullable UIImage *)imageByScalingAspectFitSize:(CGSize)size;
...
- (nullable UIImage *)imageByScalingAspectFitSize:(CGSize)size scale:(CGFloat)scale;
