//
//  TrueIDGalleryCollectionView.swift
//  AmityUIKit
//
//  Created by PrInCeInFiNiTy on 10/11/2564 BE.
...
protocol TrueIDGalleryCollectionViewDelegate: AnyObject {
...
class TrueIDGalleryCollectionView: UICollectionView {
    ...
    weak var actionDelegate: TrueIDGalleryCollectionViewDelegate?
    ...
    public static func height(for contentWidth: CGFloat, numberOfItems: Int) -> CGFloat {
        ...
        if TrueIDLayout.preferredSement(numberOfItems, isEditingeMode: true) == .grid && numberOfItems > 1 {
...
extension TrueIDGalleryCollectionView: UICollectionViewDataSource {
...
extension TrueIDGalleryCollectionView: UICollectionViewDelegateFlowLayout {
...
extension TrueIDGalleryCollectionView: AmityGalleryCollectionViewCellDelegate {
