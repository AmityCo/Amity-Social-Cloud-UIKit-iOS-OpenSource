//
//  TrueIDCollectionViewLayout.swift
//  AmityUIKit
//
...
class TrueIDLayout: UICollectionViewFlowLayout {
...
//            return .four
    ...
    override func prepare() {
        ...
        var currentIndex = 0
        var segment = TrueIDLayout.preferredSement(count, isEditingeMode: isEditingeMode)
        ...
        while currentIndex < count {
            ...
            case .grid:
                ...
                segmentRects = [firstRects, secondRects]
            }
