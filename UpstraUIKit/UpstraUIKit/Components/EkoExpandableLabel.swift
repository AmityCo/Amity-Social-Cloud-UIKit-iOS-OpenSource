...
/**
 * The delegate of EkoExpandableLabel.
 */
public protocol EkoExpandableLabelDelegate: class {
    func willExpandLabel(_ label: EkoExpandableLabel)
    func didExpandLabel(_ label: EkoExpandableLabel)
    func willCollapseLabel(_ label: EkoExpandableLabel)
    func didCollapseLabel(_ label: EkoExpandableLabel)
    func expandableLabeldidTap(_ label: EkoExpandableLabel)
}
 ...
 * EkoExpandableLabel
 */
open class EkoExpandableLabel: UILabel {
    ...
    /// The delegate of EkoExpandableLabel
    weak open var delegate: EkoExpandableLabelDelegate?
...
extension EkoExpandableLabel {
    private func commonInit() {
        ...
        collapsedAttributedLink = NSAttributedString(string: readMoreText, attributes: [.font: UIFont.systemFont(ofSize: 14), .foregroundColor: EkoColorSet.primary])
        ellipsis = NSAttributedString(string: truncateText, attributes: [.font: UIFont.systemFont(ofSize: 14), .foregroundColor: EkoColorSet.primary])
    }
