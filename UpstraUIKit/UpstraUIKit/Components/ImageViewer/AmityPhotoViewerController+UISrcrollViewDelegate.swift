//
//  AmityPhotoViewerController+UISrcrollViewDelegate.swift
//  AmityUIKit
//
...
extension AmityPhotoViewerController: UICollectionViewDelegateFlowLayout {
    ...
    private func updateFrameFor(_ size: CGSize) {
