//
//  EkoPhotoViewerController.swift
//  UpstraUIKit
//
...
public class EkoPhotoViewerController: UIViewController {
    ...
    public weak var dataSource: EkoPhotoViewerControllerDataSource?
    
    /// Delegate
    public weak var delegate: EkoPhotoViewerControllerDelegate?
    ...
    open lazy var animator: EkoPhotoViewerBaseAnimator = EkoPhotoAnimator()
    
    public init(referencedView: UIView?, image: UIImage?) {
        let flowLayout = EkoPhotoCollectionViewFlowLayout()
        ...
        collectionView.register(EkoPhotoCollectionViewCell.self, forCellWithReuseIdentifier: NSStringFromClass(EkoPhotoCollectionViewCell.self))
        ...
        // Image view
        let newImageView = EkoPhotoImageView(frame: CGRect.zero)
    ...
    public convenience init(referencedView: UIView?, imageModel: EkoImage) {
        self.init(referencedView: referencedView, image: nil)
        imageModel.loadImage(to: imageView)
        
        if case .downloadable(let id, _) = imageModel.state {
            self.imageView.setImage(withFileId: id, placeholder: nil)
        }
    }
    ...
    override open func viewDidLoad() {
        ...
        (imageView as? EkoPhotoImageView)?.imageChangeBlock = {[weak self](image: UIImage?) -> Void in
        ...
        registerClassPhotoViewer(EkoPhotoCollectionViewCell.self)
    ...
    open override func viewWillLayoutSubviews() {
        ...
        (imageView as? EkoPhotoImageView)?.imageChangeBlock?(imageView.image)
    ...
    open override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        // Update layout
        (collectionView.collectionViewLayout as? EkoPhotoCollectionViewFlowLayout)?.currentIndex = currentPhotoIndex
    }
    ...
    @objc func _handleDoubleTapGesture(_ gesture: UITapGestureRecognizer) {
        ...
        if let cell = collectionView.cellForItem(at: indexPath) as? EkoPhotoCollectionViewCell {
            // Double tap
    ...
    private func _updateZoomScaleForSize(cell: EkoPhotoCollectionViewCell, size: CGSize) {
...
extension EkoPhotoViewerController: UIViewControllerTransitioningDelegate {
...
extension EkoPhotoViewerController: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: NSStringFromClass(EkoPhotoCollectionViewCell.self), for: indexPath) as! EkoPhotoCollectionViewCell
        cell.delegate = self
...
extension EkoPhotoViewerController {
    ...
    // If a nib is registered, it must contain exactly 1 top level object which is a EkoPhotoCollectionViewCell.
    // If a class is registered, it will be instantiated via alloc/initWithFrame:
    open func registerClassPhotoViewer(_ cellClass: Swift.AnyClass?) {
        collectionView.register(cellClass, forCellWithReuseIdentifier: NSStringFromClass(EkoPhotoCollectionViewCell.self))
    }
    
    open func registerNibForPhotoViewer(_ nib: UINib?) {
        collectionView.register(nib, forCellWithReuseIdentifier: NSStringFromClass(EkoPhotoCollectionViewCell.self))
    }
...
//MARK: EkoPhotoCollectionViewCellDelegate
extension EkoPhotoViewerController: EkoPhotoCollectionViewCellDelegate {
    
    open func collectionViewCellDidZoomOnPhoto(_ cell: EkoPhotoCollectionViewCell, atScale scale: CGFloat) {
    ...
    open func collectionViewCellDidEndZoomingOnPhoto(_ cell: EkoPhotoCollectionViewCell, atScale scale: CGFloat) {
        if let indexPath = collectionView.indexPath(for: cell) {
            // Method to override
    ...
    open func collectionViewCellWillZoomOnPhoto(_ cell: EkoPhotoCollectionViewCell) {
        if let indexPath = collectionView.indexPath(for: cell) {
            // Method to override
