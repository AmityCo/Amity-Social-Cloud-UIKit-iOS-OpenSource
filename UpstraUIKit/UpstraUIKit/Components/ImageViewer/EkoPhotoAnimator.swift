...
///
public protocol EkoPhotoViewerBaseAnimator: UIViewControllerAnimatedTransitioning {
...
public class EkoPhotoAnimator: NSObject, EkoPhotoViewerBaseAnimator {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if isPresenting {
            guard let photoViewerController = toViewController as? EkoPhotoViewerController else {
                fatalError("view controller does not conform EkoPhotoViewer")
            }
            ...
            guard let photoViewerController = fromViewController as? EkoPhotoViewerController else {
                fatalError("view controller does not conform EkoPhotoViewer")
            }
