...
final class EkoFloatingButton: UIButton {
    
    enum Position {
        case topLeft, topRight, bottomLeft, bottomRight
    }
    
    var actionHandler: ((EkoFloatingButton) -> Void)?
    ...
    override func draw(_ rect: CGRect) {
        layer.backgroundColor = EkoColorSet.primary.cgColor
