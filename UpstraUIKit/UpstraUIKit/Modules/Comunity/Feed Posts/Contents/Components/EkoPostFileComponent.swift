...
/**
 ...
 - `EkoPostFileTableViewCell`
 - `EkoPostFooterTableViewCell`
 - `EkoPostPreviewCommentTableViewCell`
 
 */
public struct EkoPostFileComponent: EkoPostComposable {
    ...
    public func getComponentCell(_ tableView: UITableView, at indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            return cell
        case 1:
            let cell: EkoPostFileTableViewCell = tableView.dequeueReusableCell(for: indexPath)
