//
//  EkoColorPaletteTableViewController.swift
//  UpstraUIKit
//
...
public class EkoColorPaletteTableViewController: UITableViewController {

    private var providedColors: [UIColor] = [
        EkoColorSet.primary,
        EkoColorSet.secondary,
        EkoColorSet.alert,
        EkoColorSet.highlight,
        EkoColorSet.base,
        EkoColorSet.baseInverse,
        EkoColorSet.messageBubble,
        EkoColorSet.messageBubbleInverse
    ]
