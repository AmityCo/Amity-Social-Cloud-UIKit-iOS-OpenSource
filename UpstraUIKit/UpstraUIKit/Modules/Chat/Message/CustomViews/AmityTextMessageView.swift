...
class AmityTextMessageView: AmityView {
    ...
    private func setupView() {
        ...
        readmoreLabel.text = AmityLocalizedStringSet.messageReadmore.localizedString
        readmoreLabel.font = AmityFontSet.body
    }
...
private extension AmityTextMessageView {
