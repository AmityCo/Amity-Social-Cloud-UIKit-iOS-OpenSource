...
class EkoProfileContainerViewController : UIViewController, UIScrollViewDelegate {
    ...
    weak var dataSource: EkoProfileDataSource!
    weak var delegate: EkoProfileProgressDelegate?
    ...
    private var bottomVC: (UIViewController & EkoProfilePagerAwareProtocol)!
    ...
    override func viewDidLoad() {
        ...
        delegate?.eko_scrollViewDidLoad(overlayScrollView)
    }
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        self.delegate?.eko_scrollView(self.containerScrollView, didUpdate: progress)
    }
}

//MARK: EkoProfileBottomPageDelegate
extension EkoProfileContainerViewController : EkoProfileBottomPageDelegate {

    func eko_pageViewController(_ currentViewController: UIViewController?, didSelectPageAt index: Int) {
        currentIndex = index
