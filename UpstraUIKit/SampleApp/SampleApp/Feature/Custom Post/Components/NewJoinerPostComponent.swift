...
struct NewJoinerPostComponent: EkoPostComposable {
    ...
    func getComponentCell(_ tableView: UITableView, at indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "EkoPostNewJoinerTableViewCell", for: indexPath) as! EkoPostNewJoinerTableViewCell
