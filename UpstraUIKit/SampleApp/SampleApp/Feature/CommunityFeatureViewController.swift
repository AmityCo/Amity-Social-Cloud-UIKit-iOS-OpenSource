...
extension CommunityFeatureViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .homeByDeeplink:
//            let home = AmityCommunityHomePageFullHeaderViewController.make(amityCommunityEventType: AmityCommunityEventTypeModel(openType: .post, postID: "890615e34219985839035d50881506fd", communityID: "56701fa0443c1e92b43d89961fdc0cd4"))
