...
extension CommunityFeatureViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .homeByDeeplink:
            let home = AmityCommunityHomePageFullHeaderViewController.make(amityCommunityEventType: AmityCommunityEventTypeModel(openType: .post, postID: "629efb71b8a96200da1dbddf"))
