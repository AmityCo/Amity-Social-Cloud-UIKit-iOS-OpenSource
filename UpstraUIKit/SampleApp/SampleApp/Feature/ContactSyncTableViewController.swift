//
//  ContactSyncTableViewController.swift
//  SampleApp
//
...
class ContactSyncTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
        
    @IBOutlet weak var tableView: UITableView!
    var contactData: [AmityContactModel] = []
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ContactSyncTableViewCell", for: indexPath) as! ContactSyncTableViewCell

        cell.setup(model: contactData[indexPath.row])
